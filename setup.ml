...
(* OASIS_START *)
(* DO NOT EDIT (digest: 77865baa538bbe19c40f4a8c9ecda592) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xword"; "Cursor"];
                      lib_pack = false;
                      lib_internal_modules = ["Typedefs"; "Utils"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\216\201/\021\137`9\146\001\016O\tQ\161pt";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
