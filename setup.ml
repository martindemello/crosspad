...
(* OASIS_START *)
(* DO NOT EDIT (digest: f134ae2f62dfae201c99f51ef097bcc0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = ["source_patterns"];
          beta_features = [];
          name = "crosspad";
          license_file = None;
          copyrights = [];
          ...
          homepage = None;
          bugreports = None;
          synopsis = "Crossword file format converter and viewer";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\134\219\129\027\014\187\170$\247\231\240\157U\182\1600";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
