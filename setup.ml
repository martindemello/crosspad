...
(* OASIS_START *)
(* DO NOT EDIT (digest: c97bcb4f46951346d7bfecb9c9b39905) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/martindemello/crosspad";
          bugreports = None;
          synopsis =
            "Crossword grid manipulation library, file format converter and viewer";
          description =
            Some
              [
                 OASISText.Para
                   "This library defines an `xword` datatype, a library of useful functions, and conversions to and from various file formats. Also included are a command line file conversion tool and a gtk-based viewer."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xword"; "Cursor"; "Typedefs"];
                      lib_pack = false;
                      lib_internal_modules = ["Utils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xword";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/converter";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           FindlibPackage ("angstrom", None);
                           FindlibPackage ("bitstring", None);
                           FindlibPackage ("bitstring.ppx", None);
                           FindlibPackage ("containers", None);
                           InternalLibrary "xword"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "xword";
                      lib_findlib_name = Some "convert";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "crosspad-model";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/model";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "xword"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Crosspad_model"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xword";
                      lib_findlib_name = Some "crosspad-model";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cli.ml"});
               Executable
                 ({
                     cs_name = "crosspad";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lablgtk2.auto-init", None);
                           InternalLibrary "xword";
                           InternalLibrary "converter";
                           InternalLibrary "crosspad-model"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "gtkgui.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/martindemello/crosspad";
                      src_repo_browser =
                        Some "https://github.com/martindemello/crosspad";
     ...
     oasis_digest = Some "\197\133\140+^\030{\232\202R\253\247\024\004\018B";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
